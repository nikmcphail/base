...
public:
  ...
  color_t(const int r, const int g, const int b, const int a = 255) : r(r), g(g), b(b), a(a) {}

  color_t operator-(const int val) const {
    color_t return_val = {255, 255, 255};
...
public:
  ...
  virtual void        set_value(color_t value);
  ...
  virtual void internal_set_color_value(color_t value);
